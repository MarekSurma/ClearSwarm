...
class PromptLoader:
    ...
    FALLBACK_PROMPTS = {
        ...
        'runtime_messages': {
            ...
            'tasks_launched_with_wait_option': 'SYSTEM NOTIFICATION: {task_count} task(s) launched asynchronously:\n{task_list}\n\nDO NOT create duplicate tasks.\n\nYou can call \'wait_for_async_answers\' tool to wait for all launched tasks to complete. All results will be delivered to you at once.\nIf you don\'t use this tool, results will arrive one by one as tasks finish.\nTo use it:\n<tool_call>\n<tool_name>wait_for_async_answers</tool_name>\n<parameters>\n{{}}\n</parameters>\n</tool_call>\n',
            'wait_for_async_acknowledged': 'Acknowledged: Waiting for all async tasks to complete. All results will be delivered at once.\n',
            'wait_for_async_no_tasks': 'Note: wait_for_async_answers was called, but there are no outstanding async tasks.\n',
