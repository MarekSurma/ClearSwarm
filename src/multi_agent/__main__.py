...
from .core.prompts import set_prompt_loader
...
async def async_main():
    ...
    # Initialize prompt loader with specified prompts file
    set_prompt_loader(prompts_file=args.prompts_file)

    # Initialize loaders
    tool_loader = ToolLoader()
    tool_loader.load_tools()

    agent_loader = AgentLoader(tool_loader=tool_loader)
